...
1. Apply PCA on the independent variables of IRIS Dataset. Hint: Use prcomp function from stats library. Load the data and keep only the first 4 variables.
```{r}
data(iris)
iris_x <-iris[,1:4]
...
2. Plot the proportion of variance explained by each component. How many components will you choose to capture maximum variability in the data set?
```{r}
