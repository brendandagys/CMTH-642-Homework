...
sum(rank(c(x, y))[1:6]) #sum of ranks assigned to the group x
[1] 35
sum(rank(c(x, y))[7:12]) #sum of ranks assigned to the group y
[1] 43
...
and confirm our statistic decision. Here is how to calculate the two sums.
